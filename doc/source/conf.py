...
project = "minikube-proxy-installer"
copyright = "2020, Romain THERRAT (POCKOST)"
author = "Romain THERRAT (POCKOST)"
version = "0.0.1"
release = "0.0.1"
...
extensions = [
    "sphinxcontrib.restbuilder", "sphinxcontrib.globalsubs", "sphinx-prompt",
...
substitutions = [("|AUTHOR|", author), ("|PROJECT|", project)]
